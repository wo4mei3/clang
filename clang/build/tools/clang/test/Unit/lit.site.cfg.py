# Autogenerated from /home/wo4mei3/micclang/llvm-project/clang/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
lit_config.load_config(
    config, os.path.join(path(r"/home/wo4mei3/micclang/llvm-project/clang"), "test/Unit/lit.cfg.py"))
